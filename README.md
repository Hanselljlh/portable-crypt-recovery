...
**Windows:**
```powershell
.\packaging\windows\build.ps1 -Version "0.1.30"
# Output: dist\PCR-windows-portable-0.1.30.zip
```

**Linux:**
```bash
bash packaging/linux/build.sh 0.1.30
# Output: dist/PCR-linux-portable-0.1.30.tar.gz
```
